#ifndef LEPH_SYMBOLIC_DOT_HPP
#define LEPH_SYMBOLIC_DOT_HPP
...
class Dot : public BinaryFunction<T,U,V>
{
    public:
            ...
            typename Term<V>::TermPtr termRight)
        {
            if (termLeft->toString() == BaseSymbol::zero()) {
                ...
                return typename Term<T>::TermPtr(
                    new Dot<T,U,V>(termLeft, termRight));
            }
        }
            ...
            (const BaseSymbol::BaseSymbolPtr& sym, const Any::Any& term)
        {
            ...
            return Dot<T,U,V>::create(termLeft, termRight);
        }
        
    protected:

        Dot(const typename Term<U>::TermPtr& termLeft, 
            ...
            (const BaseSymbol::BaseSymbolPtr& sym)
        {
            ...
            return Add<T>::create(
                Dot<T,U,V>::create(termLeft, argRight), 
                Dot<T,U,V>::create(argLeft, termRight));
        }
